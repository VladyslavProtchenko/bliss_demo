...
const stats = "flex w-full justify-center bg-bgDark ";
const wrapper = 'max-w-[1440px] flex flex-col md:flex-row px-[30px] md:px-[60px] lg:px-[100px] justify-between py-[60px]'
