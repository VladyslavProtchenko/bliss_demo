...
const wrapper = 'w-full max-w-[1440px] md:px-[60px] lg:px-[100px] py-[80px] px-[30px]'
const discover = " bg-bgDark w-full flex justify-center";
...
const discoverCard =
  " w-full lg:w-[48%] mb-[20px] lg:mb-0 rounded-2xl bg-bgLight p-[30px]";
