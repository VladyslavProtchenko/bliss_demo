    ...
    >
      ...
      <div className={wrapper}>
        <div className={mainContent}>
          ...
          Streamline Operations and Enhance Building Performance
          </h1>
          <p className={mainText}>
          Discover how Bliss empowers you to efficiently manage your facility, reduce energy costs, and improve occupant satisfaction in your small and medium-sized buildings.
          </p>
