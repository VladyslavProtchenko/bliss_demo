    ...
    >
      ...
      <div className={mainContent}>
        <h1 className={mainTitle}>
          Bliss Genius: Enhancing Occupant Comfort and Space Efficiency        </h1>
        <p className={mainText}>
          Transform your commercial building with real-time feedback, intelligent sensing, and smart space management.        </p>
